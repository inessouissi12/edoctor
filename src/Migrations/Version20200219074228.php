 ...
 */
final class Version20200219074228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, cin INT NOT NULL, sexe VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, date_nais DATE NOT NULL, numtel INT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, numcarnet INT DEFAULT NULL, validite_carnet DATE DEFAULT NULL, group_sang VARCHAR(255) DEFAULT NULL, profession VARCHAR(255) DEFAULT NULL, etat_civile VARCHAR(255) DEFAULT NULL, numserieM INT DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3ABE530DA (cin), UNIQUE INDEX UNIQ_1D1C63B3F85E0677 (username), UNIQUE INDEX UNIQ_1D1C63B37434FDF5 (numtel), UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B34DE7DC5C (adresse_id), UNIQUE INDEX UNIQ_1D1C63B336CA416C (numserieM), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, adresse LONGTEXT NOT NULL, code_postal INT NOT NULL, ville VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
